...
case "3"
getcompanyregstatue="<font color='#0000ff'>未完成注册</font>"
case else
...
select case sid
case "0"
gettenderstatue="<font color='#0000ff'>A</font>"
case "1"
gettenderstatue="<font color='#0000ff'>B</font>"
case "2"
gettenderstatue="<font color='#ff0000'>C</font>"
case "3"
gettenderstatue="<font color='#0000ff'>D</font>"
case "4"
gettenderstatue="<font color='#0000ff'>D</font>"
case else
gettenderstatue="<font color='#ff0000'>E</font>"
end select
end function
...
if tid=0 then
	...
	if rss.eof then
		showtendergrade="<font color=red>Unknow等级</font>"
	else
...
showadmingrade="R&D"
case "3"
showadmingrade="TAC/IPL"
case "99"
showadmingrade="Administrator"
case else
showadmingrade="Unknow"
end select
end  function
...
<td align='right'>&nbsp;</td>
<td width='100' align='right'> <a onclick='location.reload();'><img style='cursor:hand;' alt='Refresh' border='0' src='images/reload.png'></a>  </td>
</tr>
</table>
<%
end sub
sub WhereTableC(pic,title,refresh,ty,picid,web)
%>
<table class='header' border='0' cellspacing='0' cellpadding='0' width='100%'>
<tr>
<td><img border='0' src='images/<%=pic%>' align='absmiddle' width='32' height='32'> <font style='font-size:16pt;'><%=title%></font>

</td>  
<td align='right'></td>
<td width='100' align='right'><a onclick='location.reload();'><img style='cursor:hand;' alt='刷新本页面' border='0' src='images/reload.png'></a>&nbsp;&nbsp;&nbsp;&nbsp;<% Call MyCounter(refresh,ty,picid,web) %></td>
</tr>
</table>
<%
end Sub
Sub MyCounter(refresh,ty,picid,web)
	Dim CountNum
	SET Rs = Server.CreateObject("ADODB.Recordset")
	Rs.Open "Select * From tblcounter where Web='"&Web&"'" , connFT,1,3
	Select Case refresh
	    '刷新不计数
		Case 1
...
End Sub
sub WhereTableS(pic,title,refresh,ty,picid,web)
%>
<table class='header' border='0' cellspacing='0' cellpadding='0' width='100%'>
<tr>
<td><img border='0' src='images/<%=pic%>' align='absmiddle' width='32' height='32'> <font style='font-size:16pt;'><%=title%></font>
...
<td align='right'></td>
<td width='100' align='right'><a onclick='location.reload();'><img style='cursor:hand;' alt='刷新本页面' border='0' src='images/reload.png'></a>&nbsp;&nbsp;&nbsp;&nbsp;<% Call MyCounterS(refresh,ty,picid,web) %></td>
</tr>
</table>
<%
end Sub
Sub MyCounterS(refresh,ty,picid,web)
	Dim CountNum
	SET Rs = Server.CreateObject("ADODB.Recordset")
	Rs.Open "Select * From tblcounter where Web='"&Web&"'" , connSC,1,3
	Select Case refresh
	    '刷新不计数
		Case 1
			if isempty(session("number")) then
...
Sub DispNum(CountNum,ty,picid)
	If ty="True" Then
		...
		Response.write (G)
               ' response.write(" ")
	Else
		response.write(" <font color=#FFC700><b>"&CountNum&"</b></font> ")
	End If
End Sub
dim getallxiashustr
sub getallxiashu(a1)
